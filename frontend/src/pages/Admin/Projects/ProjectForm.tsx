    ...
    <div className="project-form">
      <div className="admin-header">
        <div className="admin-header__title">
          <button onClick={() => navigate('/admin/projects')} className="button button--icon">
            <ArrowLeft size={20} />
          </button>
            ...
            <div className="form-card">
              ...
              <div className="form-group">
                ...
                <div className="input-group">
                  <LinkIcon size={18} />
                  <input type="url" placeholder="GitHub URL" {...register('links.github')} />
                </div>
                <div className="input-group">
                  <LinkIcon size={18} />
                  <input type="url" placeholder="Live URL" {...register('links.live')} />
                </div>
                <div className="input-group">
                  <LinkIcon size={18} />
                  <input
